...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark text-white" style="background-color: black;">
        <a class="navbar-brand" href="{{route('society.home')}}">SOCIETY</a>
        ...
        <div class="navbar-collapse collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item mx-2">
                    <a class="nav-link text-light {{ request()->routeIs('society.attendence') ? 'active' : '' }}" href="{{route('society.attendence')}}">Attendence</a>
                </li>
            </ul>
            <!-- Login Button -->
