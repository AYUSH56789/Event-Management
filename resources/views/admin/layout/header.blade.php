        ...
        <div class="navbar-collapse collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item mx-2">
                    <a class="nav-link text-light {{ request()->routeIs('admin.home') ? 'active' : '' }}" href="{{route('admin.home')}}">Home </a>
                </li>
                <li class="nav-item mx-2">
                    <a class="nav-link text-light {{ request()->routeIs('admin.society') ? 'active' : '' }}" href="{{route('admin.society')}}">Society</a>
                </li>
                <li class="nav-item mx-2">
                    <a class="nav-link text-light {{ request()->routeIs('admin.registration') ? 'active' : '' }}" href="{{route('admin.registration')}}">Registration</a>
                </li>
            </ul>
            <!-- Login Button -->
